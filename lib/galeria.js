...
function adicionarFoto(caminho, projetoId, { nomeExibicao, tag, tipo, r2Key, capturaIdOrigem }) {
...
function editarFoto(caminho, projetoId, fotoId, { nomeExibicao, tag, ordem, arquivada }) {
  const estado = lerEstado(caminho);
  const galeria = estado.galerias.find((g) => g.projetoId === projetoId);
